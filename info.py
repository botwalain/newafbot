...
PICS = (environ.get('PICS', 'https://envs.sh/bdt.jpg')).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/bdt.jpg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/bdt.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://envs.sh/bdt.jpg")
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://envs.sh/Wdj.jpg'))
FSUB_PICS = (environ.get('FSUB_PICS', 'https://envs.sh/bdt.jpg')).split()  # Fsub pic

# ============================
# Admin, Channels & Users Configuration
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '2125687935').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002093599394').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002093599394'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002093599394'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002320736606'))  # Notification of those who verify will be sent to your channel
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1001878276381'))  # Premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1001793723818')  # Channel/Group ID for force sub (make sure bot is admin)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '').split()]
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001878276381')  # Support group id (make sure bot is admin)
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002320736606')  # Request channel id (make sure bot is admin)
AUTH_CHANNEL = [int(fch) if id_pattern.search(fch) else fch for fch in environ.get('AUTH_CHANNEL', '-1001793723818').split()]
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001878276381').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)


# ============================
# Payment Configuration
# ============================
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/bdt.jpg')
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'CONGRATS WE ARE OFFERING FREE SERVICE')

#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1001878276381').split()]
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ibmtwo:2003@cluster0.46shl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://ibmthree:2003@cluster0.uwggj.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "ibmtwo")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002093599394'))  # Log channel id (make sure bot is admin)
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', 'https://t.me/IBMBotSupport')  # How to open tutorial link for verification
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/IBMBotSupport')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+6evDFgzcex5jMTBl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/WholesomeCity')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/simpshh')
MOVIE_UPDATE_CHANNEL_LNK = environ.get('MOVIE_UPDATE_CHANNEL_LNK', 'https://t.me/+6evDFgzcex5jMTBl')
OWNERID = int(os.environ.get('OWNERID', '2125687935'))  # Replace with the actual admin ID
...
if HAS_SSL:
    URL = "https://occupational-isabelita-movbotbyibm-684fdecb.koyeb.app/".format(FQDN)
else:
    URL = "http://occupational-isabelita-movbotbyibm-684fdecb.koyeb.app/".format(FQDN)
